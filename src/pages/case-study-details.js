...
import caseImg2 from '../components/App/assets/images/case-study/case-study-details2.jpg'
import caseImg3 from '../components/App/assets/images/case-study/case-study-details3.jpg'
                    ...
                    <div className="details-problem">
                        ...
                        <div className="row">
                            <div className="col-sm-6 col-lg-6">
                                <div className="img">
                                    <img src={caseImg2} alt="Details" />
                                </div>
                            </div>
                            <div className="col-sm-6 col-lg-6">
                                <div className="img">
                                    <img src={caseImg3} alt="Details" />
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="contact-content">
                                        <div className="top">
                                            <ul>
                                                ...
                                                <li>
                                                    <span>Website:</span>
                                                    <a href="http://reton.com" target="_blank">www.reton.com</a>
                                                </li>
                                                <li>
                                                    <span>Address:</span>
