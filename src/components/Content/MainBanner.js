                ...
                <div className="d-table-cell">
                    <div className="container">
                        <div className="banner-content">
                            ...
                            <p>I’ve always contributed to a wider concept of social impact through my work on Tech4Good, CivicTech and RHoK, and after a year of coaching and personal reflection, I am realigning and committing to collaborate and work on the <span>climate crisis</span>.</p>
