...
import nature1 from '../../components/App/assets/images/projects/nature1.jpg'
import nature2 from '../../components/App/assets/images/projects/nature2.png'
import nature3 from '../../components/App/assets/images/projects/nature3.png'
import nature4 from '../../components/App/assets/images/projects/nature4.png'
import nature5 from '../../components/App/assets/images/projects/nature5.png'

import aski1 from '../../components/App/assets/images/projects/aski1.jpg'

import rw1 from '../../components/App/assets/images/projects/rw1.png'
import rw2 from '../../components/App/assets/images/projects/rw2.png'

import tictactoe1 from '../../components/App/assets/images/projects/tictactoe1.jpg'
import tictactoe2 from '../../components/App/assets/images/projects/tictactoe2.jpg'
import tictactoe3 from '../../components/App/assets/images/projects/tictactoe3.jpg'
import tictactoe4 from '../../components/App/assets/images/projects/tictactoe4.jpg'
import tictactoe5 from '../../components/App/assets/images/projects/tictactoe5.jpg'
                    ...
                    <div>
                        <div className="about-content about-content--techforgood">
                            <div id="estimote" className="section-title three">                                
                                ...
                                <p style={{textAlign:"center"}}><img src={nature1} /></p>
                                ...
                                <p style={{textAlign:"center"}}><img src={nature2} /></p>
                                ...
                                <p style={{textAlign:"center"}}><img src={nature3} /></p>
                                
                                <p>Distribution of amount of time spent in the app </p> 

                                <p style={{textAlign:"center"}}><img src={nature4} /></p>
                                
                                <p>Distribution of number of beacon interactions per session</p>
                                
                                <p style={{textAlign:"center"}}><img src={nature5} /></p>
                        ...
                        <div className="about-content about-content--techforgood">
                            <div id="rw"  className="section-title three">
                               ...
                               <h2>RentingWell.com</h2>
                                ...
                                <p style={{textAlign:"center"}}><img src={rw1} /></p>

                                <p style={{textAlign:"center"}}><img src={rw2} /></p>
                    ...
                    <div>
                        <div className="about-content about-content--techforgood">
                            <div id="aski" className="section-title three">
                                ...
                                <p style={{textAlign:"center" }}><img  style={{ width: "20rem" }} src={aski1} /></p>
